...
- [x] 가설 3개 초안 완성
- [ ] Design Decision 작성 (온보딩 변경 내용, 에이전트 분리, 클립 기능 상세)
- [ ] Evidence 작성 (UT 여부 확인 필요, 정성적 근거 정리)
...
1. Design Decision 섹션 작성
   - 온보딩 플로우: 기존 vs 변경 내용 확인
   - 에이전트·에디터 공간 분리 상세
   - 클립(Context-First) 기능 상세
2. Evidence 섹션 작성
   - UT 실제 진행 여부 및 내용 확인
   - 정성적 근거 정리
3. Outcome / Reflection 완성
